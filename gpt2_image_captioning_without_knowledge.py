...
test_valid_percentage = configs.test_valid_percentage # (test - 15, valid - 15)

train_data_percentage = configs.train_data_percentage
valid_data_percentage = configs.valid_data_percentage
test_data_percentage = configs.test_data_percentage

max_target_length = configs.max_target_length
...
print("Computed average BLEU score using GPT2 Image Captioning without LLM knowledge:", average_bleu_score)